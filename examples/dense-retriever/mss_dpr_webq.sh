...
TRAIN_DATA="${DATA_DIR}/webq-train.json"
VALID_DATA="${DATA_DIR}/webq-dev.json"
...
QA_FILE_DEV="${BASE_DIR}/data/dpr/retriever/qas/webq-dev.csv"
QA_FILE_TEST="${BASE_DIR}/data/dpr/retriever/qas/webq-test.csv"
